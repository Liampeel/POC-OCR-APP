...
public class AAPRecordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AAPRecordsActivity.this, AAPHomePageActivity.class));
            }
        });
        ...
        clearDialogBuilder.setTitle("AAP Diagnoses");
    ...
    private void setListView(final List<AAPDiagnosisResponse> aapResponse) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent intent = new Intent(AAPRecordsActivity.this, AAPDetailActivity.class);
        ...
        call.enqueue(new Callback<List<AAPDiagnosisResponse>>() {
            ...
            public void onResponse(Call<List<AAPDiagnosisResponse>> call, Response<List<AAPDiagnosisResponse>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(AAPRecordsActivity.this, "Failed to Fetch Records", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<List<AAPDiagnosisResponse>> call, Throwable t) {
                Toast.makeText(AAPRecordsActivity.this, "Error Fetch Records Failed", Toast.LENGTH_LONG).show();
            }
        });
    }
