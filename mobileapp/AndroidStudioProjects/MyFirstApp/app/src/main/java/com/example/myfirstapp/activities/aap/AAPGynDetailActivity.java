...
public class AAPGynDetailActivity extends AppCompatActivity {
    private AAPDiagnosisResponse diagnosis;
    private String[] diseases = {
            "Confirm Diagnosis", "Appendicitis", "Non Specific Abdominal Pain",
            "Urinary Tract Infection", "Pelvic Inflammatory Disease", "Ovarian Cyst",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AAPGynDetailActivity.this, AAPHomePageActivity.class));
            }
        });
    ...
    private void confirmDiagnosis() {
        ...
        if (selectedItem.toLowerCase().equals(diseases[0].toLowerCase()) || ((currentDiagnosis != null) && currentDiagnosis.toLowerCase().equals(selectedItem.toLowerCase()))) {
            Toast.makeText(AAPGynDetailActivity.this, "There's nothing to update!", Toast.LENGTH_LONG).show();
        } else {
    ...
    private void updateRecord(String actualDiagnosis) {
        ...
        Call<AAPDiagnosisResponse> call = RetrofitClient
                ...
                .getApi()
                .aapGynConfirmDiagnosis(diagnosis.getId().getObjectID(), actualDiagnosis);
        ...
        call.enqueue(new Callback<AAPDiagnosisResponse>() {
            ...
            public void onResponse(Call<AAPDiagnosisResponse> call, Response<AAPDiagnosisResponse> response) {
                if (response.isSuccessful()) {
                    startActivity(new Intent(AAPGynDetailActivity.this, AAPGynRecordsActivity.class));
                    Toast.makeText(AAPGynDetailActivity.this, "The record has been successfully updated", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(AAPGynDetailActivity.this, "Failed to update the confirmed diagnosis", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<AAPDiagnosisResponse> call, Throwable t) {
                Toast.makeText(AAPGynDetailActivity.this, "Failed to update the record", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void deleteRecord() {
        ...
        Call<ResponseBody> call = RetrofitClient
                .getInstanceToken(token)
                .getApi()
                .aapGynDelete(diagnosis.getId().getObjectID());

        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(AAPGynDetailActivity.this, "The record has been successfully deleted", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(AAPGynDetailActivity.this, "This record is unable to be deleted", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(AAPGynDetailActivity.this, "Failed to delete the record", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void clearData(View view) {
        ...
        clearDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                deleteRecord();
                Intent intent = new Intent(AAPGynDetailActivity.this, AAPGynRecordsActivity.class);
