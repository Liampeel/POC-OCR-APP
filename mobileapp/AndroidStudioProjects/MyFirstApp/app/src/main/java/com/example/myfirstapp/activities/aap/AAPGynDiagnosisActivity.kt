...
class AAPGynDiagnosisActivity : AppCompatActivity() {
        ...
        call.enqueue(object : Callback<AAPDiagnosisResponse?> {
            override fun onResponse(call: Call<AAPDiagnosisResponse?>, response: Response<AAPDiagnosisResponse?>) {
                if (response.isSuccessful) {
                    Toast.makeText(this@AAPGynDiagnosisActivity, "Success!", Toast.LENGTH_LONG).show()
                } else {
                    Toast.makeText(this@AAPGynDiagnosisActivity, "Diagnosis was Invalid", Toast.LENGTH_LONG).show()
                }
            }

            override fun onFailure(call: Call<AAPDiagnosisResponse?>, t: Throwable) {
                Toast.makeText(this@AAPGynDiagnosisActivity, "Error: Submitting diagnosis Failed", Toast.LENGTH_LONG).show()
            }
        })
    }
    ...
    private fun setupSurvey(surveyView: SurveyView) {
        val steps = listOf(
                InstructionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                ...
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question34),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.notStarted)),
                                        TextChoice(this.resources.getString(R.string.ceased)),
                                        TextChoice(this.resources.getString(R.string.regular)),
                                        TextChoice(this.resources.getString(R.string.irregular)),
                                        TextChoice(this.resources.getString(R.string.skip))
                                )
                        )
                ),
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question35),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.normal)),
                                        TextChoice(this.resources.getString(R.string.lateOverdue)),
                                        TextChoice(this.resources.getString(R.string.skip))
                                )
                        )
                ),
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question36),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.yes)),
                                        TextChoice(this.resources.getString(R.string.no)),
                ...
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question37),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.impossible)),
                                        TextChoice(this.resources.getString(R.string.possible)),
                                        TextChoice(this.resources.getString(R.string.confirmed)),
                                        TextChoice(this.resources.getString(R.string.skip))
                                )
                        )
                ),
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question38),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.yes)),
                                        TextChoice(this.resources.getString(R.string.no)),
                ...
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question39),
                        answerFormat = AnswerFormat.SingleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.yes)),
                                        TextChoice(this.resources.getString(R.string.skip))
                ...
                QuestionStep(
                        title = this.resources.getString(R.string.aap_gyn_diagnosis),
                        text = this.resources.getString(R.string.question40),
                        answerFormat = AnswerFormat.MultipleChoiceAnswerFormat(
                                textChoices = listOf(
                                        TextChoice(this.resources.getString(R.string.normal)),
                                        TextChoice(this.resources.getString(R.string.right)),
                                        TextChoice(this.resources.getString(R.string.left)),
                                        TextChoice(this.resources.getString(R.string.cervix)),
                                        TextChoice(this.resources.getString(R.string.general)),
                                        TextChoice(this.resources.getString(R.string.mass)),
                                        TextChoice(this.resources.getString(R.string.bloodClots)),
                                        TextChoice(this.resources.getString(R.string.skip))
                                )
                        )
                ),
        ...
        surveyView.onSurveyFinish = { taskResult: TaskResult, reason: FinishReason ->
            if (reason == FinishReason.Completed) {
                val request = JSONObject(AAPDiagnosisRequest.AAP_GYN_BASE_REQUEST)
